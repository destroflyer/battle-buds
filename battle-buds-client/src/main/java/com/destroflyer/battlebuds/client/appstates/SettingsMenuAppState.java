...
public class SettingsMenuAppState extends MenuAppState {
    ...
    public void recreateMenu() {
        ...
        btnBack.setLocalTranslation(backMargin, fpsCounterHeight + backMargin + backIconSize, 0);
        ...
        btnBack.addCommands(Button.ButtonAction.Up, _ -> openMenu(MainMenuAppState.class));
